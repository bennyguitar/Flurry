Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/rafalwojcik/Flurry.git', :tag => s.version }
  ...
  s.subspec 'FlurrySDK' do |ss|
    ...
    ss.preserve_paths = 'Flurry/*'
    ss.library = 'Flurry'
    ss.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/FlurrySDK/Flurry"' }
  end
